...
template <typename T> struct Incrementable : PreIncrementable<T>, PostIncrementable<T> {};

template <typename T> struct Decrementable : PreDecrementable<T>, PostDecrementable<T> {};

...
class FilterIterator
    : public BaseIterator<FilterIterator<It, Predicate>, It, Predicate, false> {
...
public:
  ...
  using BaseIterator<FilterIterator<It, Predicate>, It,
                     Predicate, false>::BaseIterator;

  FilterIterator(It it, It sentinelBegin, It sentinelEnd, Predicate function)
      : BaseIterator<FilterIterator<It, Predicate>, It, Predicate, false>{
